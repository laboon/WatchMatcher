...
% Laboon changes: 
%   - moved to watchmatcher directory
%   - commented out auto-download
%   - GIFs show up ugly in MATLAB, using jpg again
%   - Removed tiny problem option
%   - Increased training
%
%
%
...
conf.calDir = '/Users/wlaboon/cmu/ml/project/test/images' ;
conf.dataDir = 'data/' ;
conf.autoDownloadData = false ;
conf.numTrain = 1 ;
conf.numTest = 0 ;
conf.numClasses = 4000 ;
conf.numWords = 100 ;
...
disp(sprintf('ClassLen = %i / selTest = %i\n', length(classes), selTest));
